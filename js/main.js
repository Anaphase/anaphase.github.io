...
var entries = [

  {
    ...
    tags: ["Amazon Web Services (Elastic Beanstalk, EC2, RDS)", "PHP", "<a href='http://www.slimframework.com/'>Slim</a>", "REST", "Zend Framework 2", "HTML5", "CSS3", "LESS", "JavaScript", "jQuery", "Handlebars", "Backbone", "Underscore", "MySQL", "Linux Admix", "Bash Scripting", "git", "<a href='http://brunch.io/'>Brunch</a>"],
    nsfw: false
  },
...

  {
    ...
    description: "<p>When HTML5 was released, I wrote a bunch of silly <a hre='http://www.w3schools.com/html/html5_canvas.asp'>Canvas</a> experiments to play around with the new features.</p>",
  ...
  var PortfolioView = Backbone.View.extend({
    ...
    initialize: function () {
      ...
      this.forEachType(function (type) {
        ...
        this.events["click #" + type + " .more-button"] = function(e) {
          ...
          this.$el.find("#" + type + " .portfolio-entry:hidden").slice(0, this.numEntriesToShow).wrapAll("<div style='display: none;' />").show().parent().slideDown(function(){
            // update scrollspy
    ...
    render: function () {
      ...
      this.forEachType(function (type) {
        ...
        // reder each entry with this type
